    ...
    <div>
        ...
        <div class="row">
            <div class="col s10 m11">
                <input v-model="newTask" type="text" class="form-control" placeholder="Add your task!">
            </div>
            <div class="col s2 m1">
        ...
        <!--完了済タスク表示ボタン-->
        <div class="btn" v-on:click="displayFinishedTasks">Display completed tasks</div>
        <!--完了済タスク一覧-->
    ...
    export default {
        ...
        methods: {
            ...
            createTask: function () {
                ...
                axios.post('/api/tasks', { task: { name: this.newTask, done: false } }).then((response) => {
